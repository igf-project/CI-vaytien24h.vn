	...
	public function do_add(){
		...
		if($img != 'ERROR'){
			...
			$data = array(
				...
				'gpost_id'		=>	$this->input->post('cbo_par'),
				'intro'			=>	$this->input->post('txt_intro'),
				'fulltext'		=>	$this->input->post('txt_fulltext'),
				'meta_title'	=>	$this->input->post('txt_metatitle'),
				'meta_key'		=>	$this->input->post('txt_metakey'),
				'meta_desc'		=>	$this->input->post('txt_metadesc'),
