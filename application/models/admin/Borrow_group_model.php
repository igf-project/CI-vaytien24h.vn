<?php
Class Borrow_group_model extends CI_Model {
	private $table;
		
	function __construct() {
		parent::__construct();
	
		$this->table = 'tbl_borrow_group';
	}
    ...
    public function getListCbItem()
	{ 
		$result = $this->db->query("SELECT id, name FROM $this->table WHERE isactive=1")->result_array();;
		return $result; 
	}
