                ...
                <div class="tab-pane fade active in" id="info">
                    <div class="row">
                        <div class='form-group col-md-6'>
                            ...
                            <input name="txt_name" type="text" id="txt_name" size="45" class='form-control' placeholder='Tên bài viết' required />
                        </div>
                        ...
                        <div class='form-group col-sm-6'>
                            ...
                            <input name="fileIcon" type="file" id="file-icon" size="45" class='form-control' />
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("input#file-icon").change(function(e) {
            for (var i = 0; i < e.originalEvent.srcElement.files.length; i++) {
                var file = e.originalEvent.srcElement.files[i];
                var img = document.createElement("img");
                var reader = new FileReader();
