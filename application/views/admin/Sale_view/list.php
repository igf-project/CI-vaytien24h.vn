...
<form action="<?php echo $base_url ?>" method="get" enctype="multipart/form-data">
	<div class="frm-search-box form-inline pull-left">
		...
		<input class="form-control mb-2 mr-sm-2 mb-sm-0" type="text" value="<?php echo $q?>" name="q" id="txtkeyword" placeholder="Mã sản phẩm" value=""/>&nbsp;
...
<table class="table table-striped table-bordered" cellspacing="0" width="100%">
	...
	<tbody>
		...
		foreach ($result as $value) {
			...
			<td>'.$value['sale_group'].'</td>
			<td>'.date('d/m/Y', $value['start_time']).'</td>
			<td>'.date('d/m/Y', $value['end_time']).'</td>
