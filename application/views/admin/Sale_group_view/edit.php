...
<div id="path">
    <ol class="breadcrumb">
        ...
        <li class="active">Sửa nhóm sale</li>
    </ol>
</div>
<div id="action">
    <div class="box-tabs">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade active in" id="info">
                    <div class="row">
                        ...
                        <div class='form-group col-md-6'>
                            <label>% sale</label>
                            <input name="txt_percen" type="number" value="<?= $result['percen_sale'] ?>" min="0" max="100" class='form-control' placeholder='Phần trăm sale'/>
                        </div>
